...
import ImageAvatars from "./Cards/Badget";


const Dortadim = (props) => {
  const classes = useStyles();
  return (
    <div align="center">
      <MediaCard />

      <Typography align="center" className={classes.Mockton}>
          ...
          College in Virginia, looked up one of the more obscure Latin words, consectetur, from a Lorem Ipsum passage, and going
           ...
           in 45 BC. This book is a treatise on the theory of ethics, very popular during the Renaissance. The first line of
            ...
            The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections 1.10.32
             and 1.10.33 from "de Finibus Bonorum et Malorum" by Cicero are also reproduced in their exact original form, a
